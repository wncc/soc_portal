...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    api
      ...
      .then((res) => {
        ...
        alert(
          'A verification email has been sent to your IITB email. Please verify to complete registration.',
        );
        // console.log(res);
      })
      .catch((err) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div>
        {error && (
          <ErrorPopup message={error} onClose={() => setError(false)} />
        )}
        {error1 && (
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
        <div className="mx-auto max-w-lg">
          ...
          <div className="flex justify-center gap-4 my-4">
            <button
              className={`px-4 py-2 font-medium ${isMentor
          ...
          {!isMentor ? (
            ...
            >
              ...
              <span className="text-sm text-gray-600 px-6 py-2 flex justify-center dark:text-white">
              ...
              <div>
                <label htmlFor="roll_number">IITB Roll No.</label>
